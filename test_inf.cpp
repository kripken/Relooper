...
int main() {
  ...
  rl_block_add_branch_to(block_map[0], block_map[1], "!(uint(i4) >= uint(i5))");
  rl_block_add_branch_to(block_map[1], block_map[3], "true");
  rl_block_add_branch_to(block_map[2], block_map[3], "true");
  rl_block_add_branch_to(block_map[3], block_map[15], "i2 == 0");
  rl_block_add_branch_to(block_map[3], block_map[4], "!(i2 == 0)");
  rl_block_add_branch_to(block_map[4], block_map[5], "true");
  rl_block_add_branch_to(block_map[5], block_map[7], "uint(i6) >= uint(i7)");
  rl_block_add_branch_to(block_map[5], block_map[6], "!(uint(i6) >= uint(i7))");
  rl_block_add_branch_to(block_map[6], block_map[8], "true");
  rl_block_add_branch_to(block_map[7], block_map[8], "true");
  rl_block_add_branch_to(block_map[8], block_map[10], "uint(i6) >= uint(i7)");
  rl_block_add_branch_to(block_map[8], block_map[9], "!(uint(i6) >= uint(i7))");
  rl_block_add_branch_to(block_map[9], block_map[11], "true");
  rl_block_add_branch_to(block_map[10], block_map[11], "true");
  rl_block_add_branch_to(block_map[11], block_map[13], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[11], block_map[12], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[12], block_map[14], "true");
  rl_block_add_branch_to(block_map[13], block_map[14], "true");
  rl_block_add_branch_to(block_map[14], block_map[5], "i2 != 0");
  rl_block_add_branch_to(block_map[14], block_map[15], "!(i2 != 0)");
  rl_block_add_branch_to(block_map[15], block_map[17], "uint(i4) >= uint(i5)");
  rl_block_add_branch_to(block_map[15], block_map[16], "!(uint(i4) >= uint(i5))");
  rl_block_add_branch_to(block_map[16], block_map[18], "true");
  rl_block_add_branch_to(block_map[17], block_map[18], "true");
  rl_block_add_branch_to(block_map[18], block_map[102], "i2 == 0");
  rl_block_add_branch_to(block_map[18], block_map[19], "!(i2 == 0)");
  rl_block_add_branch_to(block_map[19], block_map[20], "true");
  rl_block_add_branch_to(block_map[20], block_map[22], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[20], block_map[21], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[21], block_map[23], "true");
  rl_block_add_branch_to(block_map[22], block_map[23], "true");
  rl_block_add_branch_to(block_map[23], block_map[25], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[23], block_map[24], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[24], block_map[26], "true");
  rl_block_add_branch_to(block_map[25], block_map[26], "true");
  rl_block_add_branch_to(block_map[26], block_map[28], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[26], block_map[27], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[27], block_map[29], "true");
  rl_block_add_branch_to(block_map[28], block_map[29], "true");
  rl_block_add_branch_to(block_map[29], block_map[31], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[29], block_map[30], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[30], block_map[32], "true");
  rl_block_add_branch_to(block_map[31], block_map[32], "true");
  rl_block_add_branch_to(block_map[32], block_map[34], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[32], block_map[33], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[33], block_map[35], "true");
  rl_block_add_branch_to(block_map[34], block_map[35], "true");
  rl_block_add_branch_to(block_map[35], block_map[37], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[35], block_map[36], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[36], block_map[38], "true");
  rl_block_add_branch_to(block_map[37], block_map[38], "true");
  rl_block_add_branch_to(block_map[38], block_map[40], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[38], block_map[39], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[39], block_map[41], "true");
  rl_block_add_branch_to(block_map[40], block_map[41], "true");
  rl_block_add_branch_to(block_map[41], block_map[43], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[41], block_map[42], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[42], block_map[44], "true");
  rl_block_add_branch_to(block_map[43], block_map[44], "true");
  rl_block_add_branch_to(block_map[44], block_map[46], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[44], block_map[45], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[45], block_map[47], "true");
  rl_block_add_branch_to(block_map[46], block_map[47], "true");
  rl_block_add_branch_to(block_map[47], block_map[49], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[47], block_map[48], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[48], block_map[50], "true");
  rl_block_add_branch_to(block_map[49], block_map[50], "true");
  rl_block_add_branch_to(block_map[50], block_map[52], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[50], block_map[51], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[51], block_map[53], "true");
  rl_block_add_branch_to(block_map[52], block_map[53], "true");
  rl_block_add_branch_to(block_map[53], block_map[55], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[53], block_map[54], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[54], block_map[56], "true");
  rl_block_add_branch_to(block_map[55], block_map[56], "true");
  rl_block_add_branch_to(block_map[56], block_map[58], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[56], block_map[57], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[57], block_map[59], "true");
  rl_block_add_branch_to(block_map[58], block_map[59], "true");
  rl_block_add_branch_to(block_map[59], block_map[61], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[59], block_map[60], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[60], block_map[62], "true");
  rl_block_add_branch_to(block_map[61], block_map[62], "true");
  rl_block_add_branch_to(block_map[62], block_map[64], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[62], block_map[63], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[63], block_map[65], "true");
  rl_block_add_branch_to(block_map[64], block_map[65], "true");
  rl_block_add_branch_to(block_map[65], block_map[67], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[65], block_map[66], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[66], block_map[68], "true");
  rl_block_add_branch_to(block_map[67], block_map[68], "true");
  rl_block_add_branch_to(block_map[68], block_map[70], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[68], block_map[69], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[69], block_map[71], "true");
  rl_block_add_branch_to(block_map[70], block_map[71], "true");
  rl_block_add_branch_to(block_map[71], block_map[73], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[71], block_map[72], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[72], block_map[74], "true");
  rl_block_add_branch_to(block_map[73], block_map[74], "true");
  rl_block_add_branch_to(block_map[74], block_map[76], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[74], block_map[75], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[75], block_map[77], "true");
  rl_block_add_branch_to(block_map[76], block_map[77], "true");
  rl_block_add_branch_to(block_map[77], block_map[79], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[77], block_map[78], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[78], block_map[80], "true");
  rl_block_add_branch_to(block_map[79], block_map[80], "true");
  rl_block_add_branch_to(block_map[80], block_map[82], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[80], block_map[81], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[81], block_map[83], "true");
  rl_block_add_branch_to(block_map[82], block_map[83], "true");
  rl_block_add_branch_to(block_map[83], block_map[85], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[83], block_map[84], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[84], block_map[86], "true");
  rl_block_add_branch_to(block_map[85], block_map[86], "true");
  rl_block_add_branch_to(block_map[86], block_map[88], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[86], block_map[87], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[87], block_map[89], "true");
  rl_block_add_branch_to(block_map[88], block_map[89], "true");
  rl_block_add_branch_to(block_map[89], block_map[91], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[89], block_map[90], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[90], block_map[92], "true");
  rl_block_add_branch_to(block_map[91], block_map[92], "true");
  rl_block_add_branch_to(block_map[92], block_map[94], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[92], block_map[93], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[93], block_map[95], "true");
  rl_block_add_branch_to(block_map[94], block_map[95], "true");
  rl_block_add_branch_to(block_map[95], block_map[97], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[95], block_map[96], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[96], block_map[98], "true");
  rl_block_add_branch_to(block_map[97], block_map[98], "true");
  rl_block_add_branch_to(block_map[98], block_map[100], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[98], block_map[99], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[99], block_map[101], "true");
  rl_block_add_branch_to(block_map[100], block_map[101], "true");
  rl_block_add_branch_to(block_map[101], block_map[20], "i2 != 0");
  rl_block_add_branch_to(block_map[101], block_map[102], "!(i2 != 0)");
  rl_block_add_branch_to(block_map[102], block_map[104], "uint(i4) >= uint(i5)");
  rl_block_add_branch_to(block_map[102], block_map[103], "!(uint(i4) >= uint(i5))");
  rl_block_add_branch_to(block_map[103], block_map[105], "true");
  rl_block_add_branch_to(block_map[104], block_map[105], "true");
  rl_block_add_branch_to(block_map[105], block_map[168], "i2 == 0");
  rl_block_add_branch_to(block_map[105], block_map[106], "!(i2 == 0)");
  rl_block_add_branch_to(block_map[106], block_map[107], "true");
  rl_block_add_branch_to(block_map[107], block_map[109], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[107], block_map[108], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[108], block_map[110], "true");
  rl_block_add_branch_to(block_map[109], block_map[110], "true");
  rl_block_add_branch_to(block_map[110], block_map[112], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[110], block_map[111], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[111], block_map[113], "true");
  rl_block_add_branch_to(block_map[112], block_map[113], "true");
  rl_block_add_branch_to(block_map[113], block_map[115], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[113], block_map[114], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[114], block_map[116], "true");
  rl_block_add_branch_to(block_map[115], block_map[116], "true");
  rl_block_add_branch_to(block_map[116], block_map[118], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[116], block_map[117], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[117], block_map[119], "true");
  rl_block_add_branch_to(block_map[118], block_map[119], "true");
  rl_block_add_branch_to(block_map[119], block_map[121], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[119], block_map[120], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[120], block_map[122], "true");
  rl_block_add_branch_to(block_map[121], block_map[122], "true");
  rl_block_add_branch_to(block_map[122], block_map[124], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[122], block_map[123], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[123], block_map[125], "true");
  rl_block_add_branch_to(block_map[124], block_map[125], "true");
  rl_block_add_branch_to(block_map[125], block_map[127], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[125], block_map[126], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[126], block_map[128], "true");
  rl_block_add_branch_to(block_map[127], block_map[128], "true");
  rl_block_add_branch_to(block_map[128], block_map[130], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[128], block_map[129], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[129], block_map[131], "true");
  rl_block_add_branch_to(block_map[130], block_map[131], "true");
  rl_block_add_branch_to(block_map[131], block_map[133], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[131], block_map[132], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[132], block_map[134], "true");
  rl_block_add_branch_to(block_map[133], block_map[134], "true");
  rl_block_add_branch_to(block_map[134], block_map[136], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[134], block_map[135], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[135], block_map[137], "true");
  rl_block_add_branch_to(block_map[136], block_map[137], "true");
  rl_block_add_branch_to(block_map[137], block_map[139], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[137], block_map[138], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[138], block_map[140], "true");
  rl_block_add_branch_to(block_map[139], block_map[140], "true");
  rl_block_add_branch_to(block_map[140], block_map[142], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[140], block_map[141], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[141], block_map[143], "true");
  rl_block_add_branch_to(block_map[142], block_map[143], "true");
  rl_block_add_branch_to(block_map[143], block_map[145], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[143], block_map[144], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[144], block_map[146], "true");
  rl_block_add_branch_to(block_map[145], block_map[146], "true");
  rl_block_add_branch_to(block_map[146], block_map[148], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[146], block_map[147], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[147], block_map[149], "true");
  rl_block_add_branch_to(block_map[148], block_map[149], "true");
  rl_block_add_branch_to(block_map[149], block_map[151], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[149], block_map[150], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[150], block_map[152], "true");
  rl_block_add_branch_to(block_map[151], block_map[152], "true");
  rl_block_add_branch_to(block_map[152], block_map[154], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[152], block_map[153], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[153], block_map[155], "true");
  rl_block_add_branch_to(block_map[154], block_map[155], "true");
  rl_block_add_branch_to(block_map[155], block_map[157], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[155], block_map[156], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[156], block_map[158], "true");
  rl_block_add_branch_to(block_map[157], block_map[158], "true");
  rl_block_add_branch_to(block_map[158], block_map[160], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[158], block_map[159], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[159], block_map[161], "true");
  rl_block_add_branch_to(block_map[160], block_map[161], "true");
  rl_block_add_branch_to(block_map[161], block_map[163], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[161], block_map[162], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[162], block_map[164], "true");
  rl_block_add_branch_to(block_map[163], block_map[164], "true");
  rl_block_add_branch_to(block_map[164], block_map[166], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[164], block_map[165], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[165], block_map[167], "true");
  rl_block_add_branch_to(block_map[166], block_map[167], "true");
  rl_block_add_branch_to(block_map[167], block_map[107], "i2 != 0");
  rl_block_add_branch_to(block_map[167], block_map[168], "!(i2 != 0)");
  rl_block_add_branch_to(block_map[168], block_map[170], "uint(i4) >= uint(i5)");
  rl_block_add_branch_to(block_map[168], block_map[169], "!(uint(i4) >= uint(i5))");
  rl_block_add_branch_to(block_map[169], block_map[171], "true");
  rl_block_add_branch_to(block_map[170], block_map[171], "true");
  rl_block_add_branch_to(block_map[171], block_map[183], "i2 == 0");
  rl_block_add_branch_to(block_map[171], block_map[172], "!(i2 == 0)");
  rl_block_add_branch_to(block_map[172], block_map[173], "true");
  rl_block_add_branch_to(block_map[173], block_map[175], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[173], block_map[174], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[174], block_map[176], "true");
  rl_block_add_branch_to(block_map[175], block_map[176], "true");
  rl_block_add_branch_to(block_map[176], block_map[178], "uint(i5) >= uint(i6)");
  rl_block_add_branch_to(block_map[176], block_map[177], "!(uint(i5) >= uint(i6))");
  rl_block_add_branch_to(block_map[177], block_map[179], "true");
  rl_block_add_branch_to(block_map[178], block_map[179], "true");
  rl_block_add_branch_to(block_map[179], block_map[181], "uint(i4) >= uint(i5)");
  rl_block_add_branch_to(block_map[179], block_map[180], "!(uint(i4) >= uint(i5))");
  rl_block_add_branch_to(block_map[180], block_map[182], "true");
  rl_block_add_branch_to(block_map[181], block_map[182], "true");
  rl_block_add_branch_to(block_map[182], block_map[173], "i2 != 0");
  rl_block_add_branch_to(block_map[182], block_map[183], "!(i2 != 0)");
